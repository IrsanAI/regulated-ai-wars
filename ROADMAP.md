...
Status: **Core component (active)** (as of 2026-08-26)

## Immediate (0–4 weeks) — Sustainability foundation
- [x] MIT License
- [x] CONTRIBUTING.md
- [x] .gitignore
...
This roadmap is intentionally lean. It will be revised as the project moves from experiment to core component.
